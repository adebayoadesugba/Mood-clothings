...
export const PRODUCTS: Product[] = [
  ...
  { id: "silk-blouse", name: "Silk Bias Blouse", price: 195, category: "women", sub: "t-shirt", colors: ["#f5e6d0", "#0a0a0a", "#3a3a3a"], images: [img("photo-1551803091-e20673f15770"), img("photo-1490481651871-ab68de25d43d")], rating: 4.8, reviewCount: 76, description: "Fluid silk blouse cut on the bias for a subtle, sculptural drape." },
  ...
  { id: "leather-tote", name: "Structured Leather Tote", price: 495, category: "women", sub: "hoodies", colors: ["#1a1a1a", "#8b6f47"], images: [img("photo-1584917865442-de89df76afd3"), img("photo-1509038311940-c8b1cb4bb52d")], rating: 4.8, reviewCount: 133, description: "Full-grain leather tote with hand-burnished edges and suede-lined interior." },
  { id: "wool-scarf", name: "Merino Wool Scarf", price: 95, category: "men", sub: "hoodies", colors: ["#3a3a3a", "#8a8a8a", "#c7b299"], images: [img("photo-1520903920243-00d872a2d1c9"), img("photo-1601924994987-69e26d50dc26")], rating: 4.7, reviewCount: 87, description: "Featherweight Italian merino scarf with a subtle fringe finish." },
