  ...
  return (
    <>
      <header className="sticky top-0 z-40 bg-background/85 backdrop-blur hairline-b">
        <div className="mx-auto grid max-w-[1440px] grid-cols-[auto_1fr_auto] items-center gap-4 px-4 py-3 md:px-8">
          <div className="flex items-center gap-6">
            ...
            <nav className="hidden items-center gap-6 text-base uppercase tracking-widest md:flex">
