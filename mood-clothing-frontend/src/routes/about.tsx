...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About Us — Glamora" },
      { name: "description", content: "Glamora is a modern fashion house crafting timeless ready-to-wear for men, women, and kids. Learn our story, values, and craft." },
      { property: "og:title", content: "About Us — Glamora" },
      { property: "og:description", content: "The story behind Glamora — modern fashion, timeless style." },
    ],
  }),
  component: AboutPage,
});
    ...
    <div className="mx-auto max-w-[1100px] px-4 py-12 md:px-8 md:py-16">
      ...
      <header className="mt-6 max-w-3xl">
        ...
        <p className="mt-6 text-base text-muted-foreground md:text-lg">
          Glamora is a contemporary fashion house dedicated to editorial silhouettes and refined
      ...
      <section className="mt-16 grid gap-10 md:grid-cols-3">
        ...
        <div>
          ...
          <p className="mt-3 text-sm text-muted-foreground">
            Glamora is worn by a global community of creatives, professionals, and families. We build
