...
const TOPICS = [
  ...
  { title: "Returns & Refunds", body: "Start a return within 7 days of delivery. Refunds are processed to the original payment method within 5 business days." },
  { title: "Sizing & Fit", body: "Product-level size guides, fit notes, and personal styling recommendations." },
  { title: "Payments & Billing", body: "Accepted cards, secure Paystack checkout, invoices, and failed-payment troubleshooting." },
    ...
    <div className="mx-auto max-w-[1400px] px-4 py-12 md:px-8 md:py-16">
      ...
      <header className="mt-6 max-w-2xl">
        ...
        <p className="mt-4 text-muted-foreground">
          Browse a topic below, or reach our client care team directly we respond within two business day.
        </p>
      </header>
      ...
      <section className="mt-16 hairline-t pt-10 md:flex md:items-center md:justify-between">
        ...
        <div className="mt-6 flex flex-wrap gap-3 md:mt-0">
          ...
          <a href="https://wa.me/2349065623779" target="_blank" rel="noreferrer" className="border border-foreground px-6 py-3 text-xs uppercase tracking-widest">
            WhatsApp
          </a>
        </div>
      </section>
